...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark pl-5 fixed-top" style="background-color:#25274D !important ">
    ...
    <div class="collapse navbar-collapse" id="myMenu">
      <ul class="navbar-nav pl-5 custom-nav">
        ...
        <li class="nav-item"><a href="#Contact" class="nav-link">Contact</a></li>
         <li class="nav-item"><a href="http://localhost/My/Feedback/feedback.php" class="nav-link">Feedback</a></li>
   ...
   <li class="nav-item" style="margin-left: 100px;"><a href="displayData.php" class="nav-link"><i class="fa fa-user-circle " style="color:#DDDDDD;"></i> <?php echo $_SESSION['email'];?></a></li>
  </ul>
 </div>
...
<!-- Start slider -->
<div>
  <div class="carousel slide  " data-ride="carousel" data-interval="3000" id="jpweb" data-pause="hover">  <!--data-pause="false" -->
  ...
  <div class="container text-center border-bottom" id="Services"> 
    ...
    <div class="row mt-4">
        <div class="col-sm-4 mb-4">
            <a href="serverSecurity.php"><i class="fa fa-database fa-5x text-danger"></i></a>
            <h4 class="mt-4">Server Security</h4>
          </div>
            
      
      <div class="col-sm-4 mb-4">
        <a href="webApplication.php"><i class="fa fa-desktop fa-5x  text-primary"></i></a>
        <h4 class="mt-4">Web Application</h4>
      </div>

      <div class="col-sm-4 mb-4">
          <a href="andriod.php"><i class="fa fa-android fa-5x text-success"></i></a>
